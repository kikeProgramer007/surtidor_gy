            ...
            <div class="row mb-0">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Tipo de vehiculos</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="card card-secondary card-outline">
                    <div class="card-body">
                        <div class="d-flex justify-content-end ">
                            <div class="mb-2">
                                <a class="btn btn-dark btn-sm" href="{{ route('tipo.vehiculo.create') }}"><i
                        ...
                        <table id="example2" class="table table-bordered table-sm table-hover table-striped ">
                            ...
                            <tbody>
                                @foreach ($tipovehiculos as $item)
                                    <tr>
                                        <td>{{ $item['id'] }}</td>
                                        <td>{{ $item['descripcion'] }}</td>
                                        <td class="py-1 align-middle text-center">
                                            <div class="btn-group btn-group-sm">
                                                <a href="{{ route('tipo.vehiculo.edit', $item->id) }}" class="btn btn-default"
                                                    rel="tooltip" data-placement="top" title="Editar"><i
                                                        class="fas fa-edit"></i></a>
                                                <a href="#" class="btn btn-dark" rel="tooltip"
                                                    data-placement="top" title="Eliminar"
                                                    data-href="{{ route('tipo.vehiculo.destroy', $item->id) }}"
