...
return [
    ...
    | varias versiones, como las reglas de tamaño. Siéntase libre de ajustar
    ...
    */
    ...
    | líneas. Esto facilita la especificación de una línea de idioma
    | personalizada específica para una regla de atributo dada.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas se utilizan para intercambiar nuestro marcador de
    | posición de atributo con algo más amigable para el lector, como "Dirección
    | de Correo Electrónico" en lugar de "correo_electronico". Esto simplemente
